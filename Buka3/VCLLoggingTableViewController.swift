//
//  VCLLoggingTableViewController.swift
//
...
class VCLLoggingTableViewController : UITableViewController
{
    ...
    private func logVCL(_ msg: String) {
        ...
        if instanceCount == nil {
            instanceCount =  VCLLoggingTableViewController.bumpInstanceCount(for: className)
        }
        print("\(VCLLoggingTableViewController.logPrefix(for: className))(\(instanceCount!)) \(msg)")
    }
